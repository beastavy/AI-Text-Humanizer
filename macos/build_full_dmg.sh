...
# AI Text Humanizer Pro - Full DMG Builder
# This script creates a macOS DMG for the full version of the app with all dependencies

APP_NAME="AI Text Humanizer Pro"
BUNDLE_ID="com.example.ai-text-humanizer-pro"
VERSION="1.0.0"
PROJECT_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
BUILD_DIR="$PROJECT_ROOT/build/macos-full-dmg"
DIST_DIR="$PROJECT_ROOT/dist"
ENTRYPOINT="main.py"
ICON_ICNS="$PROJECT_ROOT/icon.icns"

echo "🚀 Starting Full DMG Build for $APP_NAME"
echo "=============================================="
...
if [ -f "$DMG_OUTPUT" ]; then
  ...
  echo ""
  echo "🎉 SUCCESS! Full DMG created successfully!"
  echo "=============================================="
